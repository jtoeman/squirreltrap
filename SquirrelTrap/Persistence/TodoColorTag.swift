...
///
/// Case order is deliberate: CaseIterable's `allCases` (declaration order)
/// drives the 4x4 popover grid directly, laid out as spectrum order across
/// rows with each hue's light/dark pair adjacent in the same row --
/// red/dark-red, orange/dark-orange, yellow/dark-yellow, lime/dark-lime,
/// green/dark-green, blue/dark-blue, purple/dark-purple, pink/dark-pink.
enum TodoColorTag: String, CaseIterable, Codable {
    case red, darkRed, orange, darkOrange
    case yellow, darkYellow, lime, darkLime
    case green, darkGreen, blue, darkBlue
    case purple, darkPurple, pink, darkPink
